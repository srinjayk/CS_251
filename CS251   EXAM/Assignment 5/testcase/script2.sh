...
rm -f result temp gen_out final_file run gmon.out result2.csv gmon.sum
...
while IFS="" read -r line; do
	...
	echo "Function1,time_spent_by_function1,Function2,time_spent_in_function2">result2.csv
	echo "" >> result2.csv
...
rm -f gmon.sum gen_out final_file result temp run
